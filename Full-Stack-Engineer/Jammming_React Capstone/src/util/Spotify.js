// need to enter in personal clientId after registering w Spotify
const clientId = ''
// need to change this redirectUri to one created via Surge and add this doman to Spotify app settings
...
const Spotify = {
    getAccessToken() {
        ...
        if(accessTokenMatch && expiresInMatch) {
            ...
            // this clears the paramaters allowing us to grab a new access token 
            // when it expires.
